    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <FunctionalComponent string="This will be displayed" function = { toggleBackgroundColor } selectedStyle = { backgroundColor }/>
                <FunctionalComponent string="Cannot think of any other sentance" function={ toggleBorderRadius } selectedStyle={ borderRadius }/>
                <FunctionalComponent string="Dragging this out" function={ toggleBorderStyle } selectedStyle={ borderStyle }/>
                </div>
            </div>
        </div>
    )
